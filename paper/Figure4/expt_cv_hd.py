...
sys.path.append('../..')
import os
os.makedirs('result_cv_hd', exist_ok=True)
...
for graph_type in graph_types:
    ...
    for b, i in enumerate(batches):
        ...
        for samplesize, n in enumerate(samplesizes):
            ...
            res_klBSS = KLBSS(Xt,Yt,s=s,betams=betamins,cv=True,K=K,mip=True)

            f_klBSS = open('result_cv_hd/Shat_klBSS_' + string + '.txt', 'a')

...
def translate(string):
    for metho in methods:
        ...
        np.savetxt('result/rec_' + metho + '_' + string + '.csv', res[0,:,:])
        np.savetxt('result/hd_' + metho + '_' + string + '.csv', res[1,:,:])
        np.savetxt('result/fdr_' + metho + '_' + string + '.csv', res[2,:,:])
        np.savetxt('result/tpr_' + metho + '_' + string + '.csv', res[3,:,:])
